...
func TestJWT(t *testing.T) {
	...
	if err != nil || clienteClaims.ClienteID != "cliente" || clienteClaims.OrdemServicoID != "ordem-servico" || len(clienteClaims.Escopos) != 2 || clienteClaims.Escopos[0] != "orcamentos:ler" || clienteClaims.Escopos[1] != "orcamentos:decidir" {
