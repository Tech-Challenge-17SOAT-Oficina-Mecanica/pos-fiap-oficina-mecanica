...
func main() {
	...
	calcularOrcamento := orcamentoApplication.NewCalcular(orcamentoInfrastructure.NewPostgresRepository(db))
	...
	mux.Handle("POST /orcamentos/{orcamentoId}/calcular", orcamentoPresentation.NewCalcularHandler(calcularOrcamento, jwt))
