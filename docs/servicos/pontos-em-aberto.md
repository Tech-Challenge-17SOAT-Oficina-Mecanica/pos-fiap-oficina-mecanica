...
| 17 | Limite máximo de `tamanho` na paginação não definido. | **Teto de 50**, devolvendo `400` acima disso. Menor que o teto de 100 dos demais contextos, por decisão do time. | [consultar-servicos.md](consultar-servicos.md) e DT-23 |
