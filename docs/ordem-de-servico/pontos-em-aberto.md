...
| 16 | A tarefa Iniciar Diagnóstico foi substituída por Registrar Problema Relatado. Confirmar a retirada definitiva do documento e da rota antiga, e remover a tarefa do checklist geral. | [`registrar-problema-relatado.md`](registrar-problema-relatado.md) | — |
